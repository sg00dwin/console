...
2. **Read the RTL best practices** from `.claude/local/rules/tests/Console_React_Component_Testing_Best_Practices.md`
3. **Read the source component** being tested to understand what users actually see
4. **Analyze the original Enzyme tests:**
